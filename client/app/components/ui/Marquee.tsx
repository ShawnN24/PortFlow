...
export default function Marquee() {
  return(
    <motion.div className="absolute left-0 w-screen z-10 mt-15 py-3 text-xl font-bold tracking-tight text-neutral-600 dark:text-neutral-200 flex overflow-hidden"
      initial={{
        opacity: 0,
        y: 10,
      }}
    ...
    >
      ...
      >
        <div className="flex justify-center items-center space-x-3 opacity-75 w-max">
          <svg viewBox="0 0 128 128" width={50} stroke="#ffffff">
